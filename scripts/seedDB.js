  ...
  db.Article
    ...
    /* 2 */
    {
      ...
      comments : [
        {
          author: "Brent",
          body: "It might be a legal risk if someone gets hurt.",
          date: new Date(Date.now())
        },
        {
          author: "Taylor",
          body: "Yeah, that's true but not many people park in that area. Might be better to budget for such a large project.",
          date: new Date(Date.now())
        }
      ],
      vote : []
    ...
    /* 3 */
    {
      ...
      comments : [
        {
          author: "Andy",
          body: "I rather get a higher sallery then the potential of a big bonus.",
          date: new Date(Date.now())
        }
      ],
      vote : []
